...
class PeepSoGroupCategoriesAdmin
{
	...
	public static function enqueue_scripts()
	{
		...
		wp_register_script('peepso-admin-groupcategories', plugin_dir_url(dirname(__FILE__)) . '../assets/js/admin-groupcategories.js',
		...
		wp_enqueue_style('peepso-groupcategories-admin', plugin_dir_url(dirname(__FILE__)) . '../assets/css/groupcategories.css');
	}
}

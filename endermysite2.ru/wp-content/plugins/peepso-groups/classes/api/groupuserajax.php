...
class PeepSoGroupUserAjax extends PeepSoGroupAjaxAbstract
{
	...
	public function passive_invite(PeepSoAjaxResponse $resp)
	{
		...
		if($success) {
			...
			$PeepSoNotifications->add_notification(get_current_user_id(), $this->_passive_user_id, $not_title, 'groups_user_invitation_send', PeepSoGroupsPlugin::MODULE_ID, $this->_group_id);

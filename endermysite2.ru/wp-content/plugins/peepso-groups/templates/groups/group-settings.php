        ...
        <section id="mainbody" class="ps-page-unstyled">
            <section id="component" role="article" class="ps-clearfix">
                ...
                <div class="ps-edit ps-edit--group">
                    ...
                    <div class="ps-edit__row ps-edit__row--group-readonly ps-js-group-is_interactable">
                        <div class="ps-edit__row-name">
                        ...
                        <div class="ps-edit__row-content">
                            <span class="ps-js-text"><?php echo ($group->is_interactable) ? __('Yes', 'groupso') : __('No', 'groupso');?></span>

                            <?php if ($group_user->can('manage_group')) { ?>
                                <div class="ps-edit__editor ps-js-editor" style="display:none">
                                    <select name="is_interactable" class="ps-select ps-full">
                                        <option value="1"><?php echo __('Yes', 'groupso');?></option>
                                ...
                                <div class="ps-edit__row-actions">
                                    <button class="ps-btn ps-btn--edit ps-btn-small ps-js-btn-edit" onclick="ps_group.edit_property(this, <?php echo $group->id; ?>, 'is_interactable');">
                                        <?php echo __('Edit','groupso');?>
                                    </button>
                                </div>
                            <?php } ?>

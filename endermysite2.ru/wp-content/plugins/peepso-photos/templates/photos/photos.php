        ...
        <section id="component" role="article" class="ps-clearfix">
            ...
            <div class="ps-tabs__wrapper">
                <div class="ps-tabs ps-tabs--arrows">
                    <div class="ps-tabs__item <?php if('latest' === $current) echo 'current' ?>"><a href="<?php echo PeepSoSharePhotos::get_url($view_user_id, 'latest'); ?>"><?php echo __('Photos', 'picso'); ?></a></div>
                    <div class="ps-tabs__item <?php if('album' === $current) echo 'current' ?>"><a href="<?php echo PeepSoSharePhotos::get_url($view_user_id, 'album'); ?>"><?php echo __('Albums', 'picso'); ?></a></div>
                </div>
            </div>

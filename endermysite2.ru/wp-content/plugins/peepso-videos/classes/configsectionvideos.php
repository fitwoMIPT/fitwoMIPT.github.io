<?php
    ...
    class PeepSoConfigSectionvideos extends PeepSoConfigSectionAbstract {
        ...
        private function video_uploads() {
            ...
            $this->set_field('videos_elastic_transcoder_separator',__('AWS Elastic Transcoder Integration - BETA','vidso'), 'separator');

            $this->args('default', '0');
            $this->args('int', TRUE);
            $this->set_field(
                'videos_enable_aws_s3_elastic_transcoder',
                __('Enable AWS S3 & Elastic Transcoder integration', 'vidso'),
                'yesno_switch'
            );
            ...
            $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon Access Key ID is required', 'vidso')));
            ...
            $this->args('validation', array('custom'));
            $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon Secret Access Key is required', 'vidso')));
            $this->set_field(
            ...
            $this->args('validation', array('custom'));
            $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon S3 Bucket is required', 'vidso')));
            $this->set_field(
            ...
            $this->args('validation', array('custom'));
            $this->args('validation_options', array('function' => array($this, 'validate_elastic_transcoder'),'error_message' => __('Amazon Elastic Transcoder Pipeline is required', 'vidso')));
            $this->set_field(
            ...
            $this->args('validation', array('custom'));
            $this->args('validation_options', array('function' => array($this, 'validate_elastic_transcoder'),'error_message' => __('Amazon Elastic Transcoder Preset is required', 'vidso')));
            $this->set_field(
            ...
            $this->set_field('videos_ffmpeg_separator',__('Conversion','vidso'), 'separator');
            ...
            $this->set_field(
                ...
                __('Allowed space per user', 'vidso'),
                'text'
            );
        ...
        public function audio_uploads() {
            ...
            // Build Group
            $this->set_group(
                'audio_uploads', __('Audio uploads', 'vidso')
            );
        }
        ...
        public function warnings() {
            ...
            <?php echo 'Video uploads are an <b>advanced experimental feature</b> in a BETA phase - one that comes with a number of strict technical requirements and limitations.'; ?>
            ...
            if(!PeepSo::get_option('videos_disable_backend_checks')) {
                echo '<br/><br/>';
                $suggested = trim(shell_exec('whereis ffmpeg'));
                if (!strlen($suggested)) {
                    $suggested = trim(exec('whereis ffmpeg'));
                }
            ...
            if(!PeepSo::get_option('videos_disable_backend_checks')) {
                ...
                $suggested = trim(shell_exec('whereis ffprobe'));
                if(!strlen($suggested)) {
                    $suggested = trim(exec('whereis ffprobe'));
                }
        ...
        public function validate_s3_requirements($value)
        {
            ...
            return ((0 === strlen($value) && isset($_POST['videos_enable_aws_s3_elastic_transcoder']) && $_POST['videos_enable_aws_s3_elastic_transcoder']) ? FALSE : TRUE);
        }

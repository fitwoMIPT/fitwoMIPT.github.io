...
//	const STATUS_SENT = 4;					// TODO: not used yet
	...
	/*
	 * Wrapper for add_message, used to queue notification e-mails (since 2.7.2)
	 * Contains additional logic to decide whether the e-mail should be enqueued or not, based on user preferences
	 */
...
//	    if($send==1) {
//            // Do not enqueue the e-mail notification if user preference is anything other than "real time"
//        $email_preference = PeepSoNotificationsIntensity::email_notifications_intensity_levels($user_id);
...
//        }
	...
	public static function html_content_type($content_type)
	{
        ...
        // #4279 @ 2.8.0.0 - the default encoding for wp_mail is UTF-8 anyway, and the fancy string seems to break MailPoet
        return ('text/html');
	}

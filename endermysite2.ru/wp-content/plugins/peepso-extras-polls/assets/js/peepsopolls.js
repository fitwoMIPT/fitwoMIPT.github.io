...
PsPolls.prototype.on_cancel = function() {
	...
	$('.ps-js-polls .ps-postbox-preview', this.$postbox)
		.hide()
		.html('');
	this.$postbox.on_change();
};
	...
	peepso.postJson(
		...
		$.proxy(function(json) {
			...
			if (json.success) {
				...
				window.psmessage.show('', json.errors).fade_out(window.psmessage.fade_time);
			}
		}, this)
	);
};

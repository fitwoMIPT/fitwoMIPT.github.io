      ...
      <div class="gc-page__options">
        ...
        <div class="gc-page__option">
          ...
          <p class="gc-page__option-desc">
            <?php esc_html_e( 'Makes header transparent (removes top padding on <body> with Builder friendly option enabled) to help header blend with page background. It will still use solid background color on scroll.', 'gecko' ); ?>
          </p>
        </div>
        ...
        <div class="gc-page__option">
          ...
          <p class="gc-page__option-desc">
            <?php esc_html_e( 'Makes page full-width without paddings around so you can use whole available space in page builder of your choice.', 'gecko' ); ?>
          </p>
        </div>
      </div>
    </div>

...
// Builds the groups array
	...
	private function general() {
        ...
        $this->args('int', TRUE);
        $this->args('validation', array('numeric', 'minval:0', 'maxval:5000'));
        ...
        $this->args('int', TRUE);
        $this->args('validation', array('numeric', 'minval:20', 'maxval:20000'));
        $this->set_field(
    ...
    private function aws() {
        ...
        $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon Access Key ID is required', 'picso')));
        ...
        $this->args('validation', array('custom'));
        $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon Secret Access Key is required', 'picso')));
        $this->set_field(
        ...
        $this->args('validation', array('custom'));
        $this->args('validation_options', array('function' => array($this, 'validate_s3_requirements'),'error_message' => __('Amazon S3 Bucket is required', 'picso')));
        $this->set_field(

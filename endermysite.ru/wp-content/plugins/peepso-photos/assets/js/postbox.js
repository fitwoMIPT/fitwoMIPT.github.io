(function($, factory) {
	...
	return peepso.createClass(name, {
		...
		initialize: function() {
			...
			// observers
			peepso.observer.addFilter('peepso_postbox_can_submit', $.proxy(this.canSubmit, this), 20, 1);
		...
		dropzoneInit: function() {
			if (!this.dropzone) {
				...
				this.dropzone.on('photo_upload_start', $.proxy(this.dropzonePhotoUploadStart, this));

...
<div class="peepso ps-page-profile ps-page--group">
    ...
    <section id="mainbody" class="ps-page--album ps-page-unstyled">
        <section id="component" role="article" class="ps-clearfix">
            ...
            <h4 class="ps-page-title ps-album__name ps-js-album-name">
                ...
                <a href="#" class="ps-icon-edit ps-js-album-name-trigger" onclick="peepso.album.edit_name(<?php echo $the_album->pho_album_id; ?>, <?php echo $act_post->post_author; ?>, this); return false;"></a>
                <?php } ?>
            </h4>
            ...
            <div class="ps-album__description ps-js-album-desc">
                    <div class="ps-album__description-title">
                        ...
                        <?php if ($can_edit) { ?>
                        <a href="#" onclick="peepso.album.edit_desc(<?php echo $the_album->pho_album_id; ?>, <?php echo $act_post->post_author; ?>, <?php echo $the_album->pho_owner_id; ?>, this); return false;">
            ...
            <div class="ps-comment cstream-respond wall-cocs" id="wall-cmt-<?php echo $act_id; ?>">
                ...
                if (is_user_logged_in() ) {
                    ...
                    $group_id = get_post_meta($the_album->pho_post_id, 'peepso_group_id', TRUE);
                    $group_user = new PeepSoGroupUser($group_id);

                    if($group_user->can('post_interact','')) {
                ...
                <div id="act-new-comment-<?php echo $act_id; ?>" class="ps-comment-reply cstream-form stream-form wallform ps-js-newcomment-<?php echo $act_id; ?> ps-js-comment-new" data-type="stream-newcomment" data-formblock="true">
                    ...
                    <div class="ps-comment-send cstream-form-submit" style="display:none;">
                        ...
                        <div class="ps-comment-actions" style="display:none;">
                            ...
                            <button onclick="return activity.comment_save(<?php echo $act_id; ?>, this);" class="ps-btn ps-btn-primary ps-button-action" disabled><?php echo __('Post', 'picso'); ?></button>
                        </div>
                    </div>
                </div>
                <?php
                    } // user can access segment group
                } // is_user_loggged_in
                ?>
            </div>

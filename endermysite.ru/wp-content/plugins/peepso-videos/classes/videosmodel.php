...
class PeepSoVideosModel
{
     ...
     * @return array $videos Unmodified videos
     */
    public function get_user_videos($media_type = 'all', $user_id, $offset = 0, $limit = 10, $sort = 'desc', $module_id = 0, $isgdpr=false)
    {
        global $wpdb;
        $siteurl = get_option( 'siteurl' );
        $siteurl = parse_url($siteurl, PHP_URL_HOST);
    ...
    public function get_num_videos($media_type = 'all', $user_id, $module_id = 0)
    {
        global $wpdb;
        $siteurl = get_option( 'siteurl' );
        $siteurl = parse_url($siteurl, PHP_URL_HOST);
     ...
     */
    public function video_size_can_fit($user_id, $size)
    {

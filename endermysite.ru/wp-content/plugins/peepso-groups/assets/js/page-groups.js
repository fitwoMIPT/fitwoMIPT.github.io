...
import peepso, { template as compileTemplate } from 'peepso';
...
class PsPageGroups extends PsPageAutoload {
	constructor(prefix) {
		...
		this._search_params = {
			...
			admin: undefined,
			keys:
				'id,name,description,date_created_formatted,members_count,url,published,avatar_url_full,privacy,groupuserajax.member_actions,groupfollowerajax.follower_actions',
			limit: 2,
			page: 1
		};
	}
